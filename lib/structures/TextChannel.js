...
class TextChannel extends GuildChannel {
    ...
    */
    ...
    sendErr(content) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: 0xFF0000, title: `<a:error:765155282208555058>` ,description: content } });
    }
    sendNSFW() {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: 0xFF0000, title: `<a:error:765155282208555058>` ,description: '[This channel needs to be NSFW for this command to work, Click me for more info](https://support.discord.com/hc/en-us/articles/115000084051-NSFW-channels-and-content)' } });
    }
    sendSuc(content) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: 0x00FF00, title: `<a:Check:765156937091514368>` ,description: content } });
    }
    sendLoading(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: 0xFFFF00, title: '<a:Loading:765158195433308200>', description: content ? content : "Loading..." } })
    }
    botPerms(perms){
        return this.client.createMessage.call(this.client, this.id, { embed: { color: 0xFF0000, title: `<a:error:765155282208555058>` ,description: "I am missing permission(s) to do this command\nPlease give me these permission(s),\n`" + perms + "`" } });
    }
    memberPerms(perms){
        return this.client.createMessage.call(this.client, this.id, { embed: { color: 0xFF0000, title: `<a:error:765155282208555058>` ,description: "You are missing permission(s) to do this command\nPermission(s) needed,\n`" + perms + "`" } });
    }
